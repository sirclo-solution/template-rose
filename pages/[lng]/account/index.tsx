...
const classesAccount = {
  ...
  mapPopupBackgroundClassName: `${styleMap.map_mapPopupContainer} ${styleMap.map_mapPopupContainer_account}`,
  ...
  shippingDetailsClassName: styleOrderHistory.order_item_labelDetailContainer,
  ...
  orderedItemsContainer: styleOrderHistory.order_item_orderedItemsContainer,
  ...
  orderedItemDetailWrapperNeedReviewClassName: styleOrderHistory.order_item_reviewedContainer,
